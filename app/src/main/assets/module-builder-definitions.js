...
(function(global){
  ...
  define({id:"time-bandits",model:"module-builder",version:6,package:{id:"time-bandits",version:6,behavior:{clock:"internal-fallback-or-upstream-follower",cvOutput:"internal-only-when-no-upstream-clock",dvOutput:"toggleable-speed-scaled",audioMode:"additive-pass-through",speedRibbon:"center-zero-left-divide-right-multiply",stateOwnership:"module-builder"}},faceplate:{livery:"clockwork",primary:"#24160f",secondary:"#d9a84f",tertiary:"#f4dfad"},defaults:{bpm:120,speed:0,probability:100,drum:"kick",tune:90,decay:180,level:75,pcmKey:null,sampleName:"BUILT-IN KICK",dvEnabled:true},controls:[{id:"speed",control:"ribbon",state:"speed",label:"DV SPEED",value:{default:0,min:-32,max:32,step:1},meta:{unit:"",center:0,leftLabel:"÷32",centerLabel:"0",rightLabel:"×32",twoSided:true},node:"controller.speed"},{id:"bpm",control:"knob",state:"bpm",label:"TIMER",value:{default:120,min:30,max:300,step:1},meta:{unit:" BPM"},node:"controller.bpm"},{id:"probability",control:"knob",state:"probability",label:"FIRE",value:{default:100,min:0,max:100,step:1},meta:{unit:"%"},node:"controller.probability"},{id:"drum",control:"selector",state:"drum",label:"DRUM",value:{default:"kick",options:["kick","snare","tom","hat"],labels:["KICK","SNARE","TOM","HAT"]},node:"controller.drum"},{id:"tune",control:"knob",state:"tune",label:"TUNE",value:{default:90,min:30,max:1200,step:1},meta:{unit:" Hz"},node:"controller.tune"},{id:"decay",control:"knob",state:"decay",label:"DECAY",value:{default:180,min:20,max:2000,step:5},meta:{unit:" ms"},node:"controller.decay"},{id:"level",control:"knob",state:"level",label:"LEVEL",value:{default:75,min:0,max:100,step:1},meta:{unit:"%"},node:"controller.level"},{id:"dvEnabled",control:"switch",state:"dvEnabled",label:"DV OUT",value:{default:true},node:"controller.dvEnabled"},{id:"soundSource",control:"screen",state:"pcmKey",label:"SAMPLE ACCESS",node:"controller.soundSource"},{id:"clockRing",control:"ledRing",label:"16 STEP CLOCK",value:{count:16},node:"indicator.clockRing"}],sources:[{id:"source.internalClock",type:"clock",mode:"fallback",state:"bpm"},{id:"source.clock",type:"clockFollower",mode:"priority"}],actions:[{id:"action.cv",type:"cvOutput",condition:"no-upstream-clock"},{id:"action.dv",type:"dvOutput",state:"dvEnabled"},{id:"action.fire",type:"probabilityTrigger",state:"probability"},{id:"action.sound",type:"drumOrPcm"}],nodes:{connections:[["source.internalClock","action.cv"],["source.internalClock","action.dv"],["source.internalClock","action.fire"],["source.clock","action.dv"],["source.clock","action.fire"],["controller.speed","action.dv"],["controller.probability","action.fire"],["controller.drum","action.sound"],["controller.tune","action.sound"],["controller.decay","action.sound"],["controller.soundSource","action.sound"],["action.fire","action.sound"],["action.fire","indicator.clockRing"]]}});
