"use strict";
(function(){
const MS=window.MultiSynth||{},M=MS.ModuleManifest,H=MS.HierarchyLibrary,E=MS.RackEngine,F=MS.RackFaceplate,MF=MS.ModuleFaceplate,P=()=>window.MultiSynthNodePlane;
