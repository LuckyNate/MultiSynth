...
function rackChoice(r,name,onPick){const b=document.createElement("button");b.type="button";b.className="nodeBrowserRackChoice";const visual=F?.render?.(r,{name,selector:true})||document.createTextNode(name);b.appendChild(visual);b.onclick=onPick;return b}
