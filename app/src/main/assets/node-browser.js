...
function rackChoice(r,name,onPick){const b=document.createElement("button");b.type="button";b.className="nodeBrowserRackChoice";const label=document.createElement("div");label.className="nodeBrowserRackName";label.textContent=name;const visual=F?.render?.(r,{name,compact:true})||document.createTextNode(name);b.append(label,visual);b.onclick=onPick;return b}
