...
function runtime(mid){const m=E().getModule(mid);if(!m)return null;try{return C().getRuntime(mid)}catch(_){try{return E().createModuleRuntime(mid,{audioContext:A()?.context,native:MS.rack?.native||null,rack:{hasUpstream:false}})}catch(__){return null}}}
