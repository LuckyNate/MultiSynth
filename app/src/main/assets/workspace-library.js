...
function render(){items.innerHTML="";const p=loadProject();for(const r of p.racks||[]){if(String(r.id).startsWith("nodehost-"))continue;items.appendChild(rackRow(r))}const n=document.createElement("button");n.type="button";n.className="rackLibraryRow new";n.innerHTML='<div><strong>+ NEW EMPTY RACK</strong><small>CREATE A NEW RACK NODE</small></div>';n.onclick=createRack;items.appendChild(n)}
render();
})();