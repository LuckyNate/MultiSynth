"use strict";
(function(global){
const MS=global.MultiSynth||{},E=MS.RackEngine,C=MS.ModuleContract,M=MS.ModuleManifest,A=MS.RackAudioGraph,S=MS.ModuleSelectorUI;
...
function saveName(){if(!editingRack)return;E.renameRack(editingRack,String(nameInput.value||"").trim());nameRow.classList.add("hidden");persist();render();global.MultiSynthNodePlane?.render?.()}
