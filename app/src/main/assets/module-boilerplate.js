...
(function(global){
  ...
  function describe(role){const s=requireRole(role);return Object.freeze({role:s.role,ports:s.ports.slice(),root:Object.freeze({identity:true,state:true,lifecycle:lifecycle.slice(),cvIn:true,cvOut:true,theme:true,decal:true})})}
