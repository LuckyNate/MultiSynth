...
(function(global){
  ...
  function theme(identity={},color="#777",override={}){const d=decal(identity,override.decal||{});return Object.freeze({key:override.key||identity.themeKey||identity.id||"module",color:override.color||color,decal:d});}
