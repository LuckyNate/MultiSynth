...
const tickListeners=new Set(),pulseListeners=new Set(),scheduledPulseListeners=new Set();
...
function activeCount(){return tickListeners.size+pulseListeners.size+scheduledPulseListeners.size}
...
function subscribeScheduledPulse(fn){return subscribe(scheduledPulseListeners,fn)}
