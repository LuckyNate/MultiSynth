...
const api={
 available(){const b=bridge();return !!b&&typeof b.startLiveWire==="function"},start(){const b=bridge();return b&&typeof b.startLiveWire==="function"?!!b.startLiveWire():false},stop(){const b=bridge();if(b&&typeof b.stopLiveWire==="function")b.stopLiveWire()},setValve(open){const b=bridge();if(b&&typeof b.setLiveWireValve==="function")b.setLiveWireValve(!!open)},
