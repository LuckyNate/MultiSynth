...
{id:"duty"+n,control:"encoder",state:"duty"+n,label:"DUTY "+n,value:{default:50,min:1,max:99,step:1},meta:{unit:"%",midi:{cc:cc+1}},node:"controller.duty"+n},
...
C.defineSurface(I.PULSYNTH,{version:5,package:{id:I.PULSYNTH,version:5,behavior:{role:"three-stage-pwm-ladder",stateOwnership:"module",sourceLayer:"DspSources",sourceOwnership:"shared-bottom-layer",voiceEnvelope:"built-in-adsr",midi:"note-on-off-velocity-pitch-bend-cc1-cc7-cc11-cc64-adsr-program-change-stage-cc20-37",stageMidi:"amount-duty-phase-detune-octave-direction"}},faceplate:{livery:"green-pwm-ladder",primary:"#061709",secondary:"#58ff78",tertiary:"#d9ffe0"},defaults,controls,sources:[{id:"source.audio",type:"audioInput",mode:"optional"},{id:"source.oscillators",type:"dspSource",primitive:"DspSources.oscillator",waveform:"square",mode:"three-stage"},{id:"source.note",type:"noteInput"},{id:"source.midi",type:"midiInput",mode:"note-and-channel-messages"}],actions:[{id:"action.ladder",type:"pwmLadder"},{id:"action.envelope",type:"builtInAdsrVca"},{id:"action.expression",type:"midiExpression"},{id:"action.modulation",type:"midiModulation"},{id:"action.sustain",type:"midiSustain"}],nodes:{connections:[["source.audio","action.ladder"],["source.oscillators","action.ladder"],["source.note","action.ladder"],["source.midi","action.ladder"],["controller.keyboard","action.ladder"],["controller.modulation","action.modulation"],["controller.sustain","action.sustain"],["action.ladder","action.envelope"],["controller.adsr","action.envelope"],["controller.level","action.ladder"],["action.expression","action.ladder"]]}});
})(window);
