...
(function(global){
  ...
  function create(api){
    ...
    runtime.player=S.sampler(ctx,samplerOut,{maxLag:.05});runtime.unsubscribeMidi=T.subscribeMidi(event=>onTransportMidi(runtime,event));
