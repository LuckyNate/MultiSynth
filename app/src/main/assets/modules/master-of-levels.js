...
C.define({type:I.MASTER_OF_LEVELS,version:"master-of-levels-3",description:"MASTER LEVEL STAGE · PRE · GAIN · OVERDRIVE · LEVEL",defaults:{pre:1,gain:1,overdrive:0,level:1},create,setState({runtime,state}){apply(runtime.user,state);},destroy,serialize:({state})=>({...state}),restore:({saved})=>({pre:1,gain:1,overdrive:0,level:1,...(saved||{})})});
})(window);
