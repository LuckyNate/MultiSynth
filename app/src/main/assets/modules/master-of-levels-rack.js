...
C.define({type:I.MASTER_OF_LEVELS,displayName:"Master of Levels",category:"processor",version:"master-of-levels-3",editorUrl:"master-of-levels.html",color:"#c61f2b",selectorClass:I.MASTER_OF_LEVELS,description:"MASTER LEVEL STAGE · PRE · GAIN · OVERDRIVE · LEVEL",defaults:{pre:1,gain:1,overdrive:0,level:1},create,setState({runtime,state}){apply(runtime.user,state);},destroy,serialize:({state})=>({...state}),restore:({saved})=>({pre:1,gain:1,overdrive:0,level:1,...(saved||{})})});
})(window);
