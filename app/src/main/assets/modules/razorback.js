...
contract.getDefinition(ids.RAZORBACK);
const defaults={level:.8,carrier:1,...prefabs.ADSR_DEFAULTS,amount1:.35,amount2:.25,amount3:.20,phase1:0,phase2:120,phase3:240,octave1:0,octave2:0,octave3:0,detune1:0,detune2:0,detune3:0,direction1:"up",direction2:"up",direction3:"up",peak1:25,peak2:50,peak3:75};
...
{id:"peak"+stage,control:"encoder",state:"peak"+stage,label:"PEAK "+stage,value:{default:[25,50,75][stage-1],min:0,max:100,step:1},meta:{unit:"%",visual:"movable-triangle-peak"},node:"controller.peak"+stage},
...
contract.defineSurface(ids.RAZORBACK,{version:4,package:{id:ids.RAZORBACK,version:4,behavior:{role:"three-stage-triangle-peak-ladder",stateOwnership:"module",sourceLayer:"DspSources",sourceOwnership:"shared-bottom-layer",voiceEnvelope:"built-in-adsr"}},faceplate:{livery:"red-razor-ladder",primary:"#190506",secondary:"#ff3d42",tertiary:"#ffd8da"},defaults,controls,sources:[{id:"source.audio",type:"audioInput",mode:"optional"},{id:"source.oscillators",type:"dspSource",primitive:"DspSources.oscillator",waveform:"triangle",mode:"three-stage"},{id:"source.note",type:"noteInput"}],actions:[{id:"action.ladder",type:"trianglePeakLadder"},{id:"action.envelope",type:"builtInAdsrVca"}],nodes:{connections:[["source.audio","action.ladder"],["source.oscillators","action.ladder"],["source.note","action.ladder"],["controller.keyboard","action.ladder"],["action.ladder","action.envelope"],["controller.adsr","action.envelope"]]}});
})(window);
