...
const defaults={};
C.define({
 type:I.LIVE_WIRE,version:"module-builder-6",description:"YOUTUBE PLAYER · HOLD TO SAMPLE",defaults,
 create(api){
...
B?.define?.({id:I.LIVE_WIRE,model:"module-builder",version:6,package:{id:I.LIVE_WIRE,version:6,behavior:{audioMode:"youtube-player-recorder",capture:"hold-to-pcm",stateOwnership:"module-builder",destroyStopsTransport:true}},faceplate:{livery:"high-voltage-crt",primary:"#081419",secondary:"#72d7ff",tertiary:"#dff7ff"},defaults,controls:[{id:"source",control:"touchscreen",label:"VIDEO PLAYER",node:"controller.source"},{id:"seek",control:"dial",label:"SEEK",meta:{unit:"s",gesture:"circular-drag",range:"wide"},node:"controller.seek"},{id:"pause",control:"button",label:"PAUSE",node:"controller.pause"},{id:"stop",control:"button",label:"STOP",node:"controller.stop"},{id:"record",control:"hold",label:"HOLD TO RECORD",node:"controller.record"}],sources:[{id:"source.youtube",type:"nativeAudio",mode:"record-only"}],actions:[{id:"action.select",type:"selectVideo"},{id:"action.seek",type:"seek"},{id:"action.pause",type:"pause"},{id:"action.stop",type:"stop"},{id:"action.record",type:"savePcm"}],nodes:{connections:[["controller.source","action.select"],["controller.seek","action.seek"],["controller.pause","action.pause"],["controller.stop","action.stop"],["controller.record","action.record"],["source.youtube","action.record"]]}});
})(window);
