...
const defaults={};
C.define({
 type:I.LIVE_WIRE,version:"module-builder-12",description:"FREESOUND AUDIO PLAYER · CV/MANUAL SAMPLE TRIGGER · 30 RPM PRECISION SEEK · HOLD OR COPY TO SAMPLE",defaults,
 create(api){
