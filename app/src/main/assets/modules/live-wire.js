...
C.define({
 type:I.LIVE_WIRE,version:"module-builder-18",description:"FREESOUND AUDIO PLAYER · MANUAL SAMPLE TRIGGER · 33⅓ RPM TURNTABLE · HOLD OR COPY TO SAMPLE",defaults,
 create(api){
