...
C.define({type:"master",displayName:"Master",category:"processor",version:"rack-master-1",editorUrl:"master.html",color:"#d6d6d6",selectorClass:"master",description:"PRE · GAIN · OVERDRIVE · LEVEL",defaults:{pre:1,gain:1,overdrive:0,level:1},create,setState({runtime,state}){apply(runtime.user,state);},destroy,serialize:({state})=>({...state}),restore:({saved})=>({pre:1,gain:1,overdrive:0,level:1,...(saved||{})})});
})(window);
