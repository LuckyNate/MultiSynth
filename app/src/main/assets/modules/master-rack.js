...
C.define({type:"master",displayName:"Father Time",category:"processor",version:"rack-master-2",editorUrl:"master.html",color:"#8b8171",selectorClass:"master",description:"ANCIENT MASTER STAGE · PRE · GAIN · OVERDRIVE · LEVEL",defaults:{pre:1,gain:1,overdrive:0,level:1},create,setState({runtime,state}){apply(runtime.user,state);},destroy,serialize:({state})=>({...state}),restore:({saved})=>({pre:1,gain:1,overdrive:0,level:1,...(saved||{})})});
})(window);
