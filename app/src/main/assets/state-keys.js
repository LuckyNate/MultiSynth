...
(function(global){
 ...
 const KEYS=Object.freeze({RUNNING:"running",LEVEL:"level",BPM:"bpm",STEPS:"steps",DV_INPUT:"dvInput",DIV_INPUT:"dvInput"});
 const ALIASES=Object.freeze({running:Object.freeze(["running"]),level:Object.freeze(["level"]),bpm:Object.freeze(["bpm"]),steps:Object.freeze(["steps"]),dvInput:Object.freeze(["dvInput","divInput"])});
 const NAME_ALIASES=Object.freeze({DIV_INPUT:"DV_INPUT",divInput:"dvInput"});
 const canonical=key=>{const raw=String(key||"");const upper=NAME_ALIASES[raw.toUpperCase()]||raw.toUpperCase();return KEYS[upper]||NAME_ALIASES[raw]||raw};
