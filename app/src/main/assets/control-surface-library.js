...
(function(global){
  ...
  // Hardware-like touch contracts. Keep these deliberately narrow where accidental gestures are costly.
  const ALLOWED_GESTURES=Object.freeze({
    ...
    // Pads are intentionally restricted: quick tap or sustained press only.
    [CONTROL.PAD]:Object.freeze([GESTURE.TAP,GESTURE.PRESS]),
    // Ribbon is a one-dimensional touch strip: direct tap, engage, move, release.
    [CONTROL.RIBBON]:Object.freeze([GESTURE.TAP,GESTURE.PRESS,GESTURE.DRAG,GESTURE.RELEASE]),
    // XY is a two-dimensional continuous surface.
  ...
  MS.ControlSurface=Object.freeze({CONTROL,GESTURE,ACTION,ALLOWED_GESTURES,define,compose,validate,supports,actionFor,listControls:()=>Object.freeze(Object.values(CONTROL)),listGestures:()=>Object.freeze(Object.values(GESTURE)),listActions:()=>Object.freeze(Object.values(ACTION))});
})(window);
