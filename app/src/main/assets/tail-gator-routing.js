...
async function setSink(id){const A=MS.RackAudioGraph;if(!A)return false;const ctx=A.context;if(typeof ctx.setSinkId!=="function")return false;try{await ctx.setSinkId(id||"");currentSink=id||"";return true;}catch(e){console.warn("Tail Gator sink",e);return false;}}
