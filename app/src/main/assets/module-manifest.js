...
(function(global){
  ...
  function routingFor(capabilities,overrides={}){
    const audioIn=has(capabilities,"audioInput"),audioOut=has(capabilities,"audioOutput"),generator=has(capabilities,"generator"),terminal=has(capabilities,"terminalOutput"),clockSource=has(capabilities,"clockSource"),clockFollower=has(capabilities,"clockFollower"),notes=has(capabilities,"noteInput");
    const base={audioRole:terminal?"terminal":generator?"generator":audioIn&&audioOut?"processor":audioOut?"generator":"none",carrierBehavior:!audioIn?"none":generator?"add":terminal?"passthrough":"transform",stereoBehavior:audioIn||audioOut?"stereoPreserve":"none",timingRole:clockSource&&clockFollower?"sourceFollower":clockSource?"source":clockFollower?"follower":"none",voiceMode:Object.freeze({mode:notes?"moduleSpecific":"none",maxVoices:null,steal:"none"}),bypassBehavior:audioIn&&audioOut?"dedicatedCarrierOutput":"none",latencySamples:0};
  ...
  const M=Object.freeze({
    ...
    [I.WHITMAN_SAMPLER]:row(I.WHITMAN_SAMPLER,"sampler","#6b3f24",["audioInput","audioOutput","noteInput","clockFollower","pcm"],["pcm","storage"],{carrierBehavior:"add"}),
    [I.TIME_BANDITS]:row(I.TIME_BANDITS,"rhythm","#c89b52",["audioInput","audioOutput","clockFollower"],[],{carrierBehavior:"add"}),
    ...
    [I.GRAIN_LIQOUR]:row(I.GRAIN_LIQOUR,"granular","#8d5fa8",["audioOutput","generator","noteInput","pcm"],["pcm","storage"]),
    ...
    [I.PLUS_ONE_SPLITTER]:row(I.PLUS_ONE_SPLITTER,"routing","#6ec7ff",["audioInput","audioOutput"],[],{carrierBehavior:"passthrough"}),
    ...
    [I.CONTROL_FREAK]:row(I.CONTROL_FREAK,"controller","#75b7ff",["noteInput","midi"],["midi"]),
    [I.LOWRIDER_LFO]:row(I.LOWRIDER_LFO,"modulator","#d6aa3c",["audioOutput","generator"],[],{audioRole:"generator"}),
    ...
    [I.TEST_MODULE]:row(I.TEST_MODULE,"utility","#d8d8d8",[]),
    ...
    [I.PULSYNTH]:row(I.PULSYNTH,"instrument","#58ff78",["audioInput","audioOutput","generator","noteInput"],[]),
    [I.SIN_LADDER]:row(I.SIN_LADDER,"instrument","#36eaff",["audioInput","audioOutput","generator","noteInput"],[]),
    [I.RAZORBACK]:row(I.RAZORBACK,"instrument","#ff3d42",["audioInput","audioOutput","generator","noteInput"],[]),
    [I.STINGER]:row(I.STINGER,"instrument","#ffe64a",["audioInput","audioOutput","generator","noteInput"],[]),
    [I.NO_QUARTER]:row(I.NO_QUARTER,"instrument","#77a4ff",["audioInput","audioOutput","generator","noteInput"],[]),
    [I.RANDRONE]:row(I.RANDRONE,"generator","#9efcff",["audioInput","audioOutput","generator","clockFollower"],[]),
