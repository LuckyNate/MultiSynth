...
(function(global){
  ...
  const M=Object.freeze({
    ...
    [I.PLUS_ONE_SPLITTER]:row(I.PLUS_ONE_SPLITTER,"routing","#6ec7ff",["audioInput","audioOutput","midiInput","midiOutput","clockFollower","clockSource"],[],{carrierBehavior:"passthrough"}),
    [I.PLUS_ONE_MERGER]:row(I.PLUS_ONE_MERGER,"routing","#ffb86e",["audioInput","audioOutput","midiInput","midiOutput","clockFollower","clockSource"],[],{carrierBehavior:"passthrough"}),
    ...
    [I.PURE_SYNTH]:row(I.PURE_SYNTH,"instrument","#f4f4f0",["audioInput","audioOutput","generator","noteInput","midiInput"],[]),
    [I.QUAD_SYNTH]:row(I.QUAD_SYNTH,"instrument","#ffb000",["audioInput","audioOutput","generator","noteInput","midiInput"],[]),
    [I.HOOK_AND_LADDER]:row(I.HOOK_AND_LADDER,"instrument","#d7261e",["audioInput","audioOutput","generator","noteInput","midiInput"],["midi"],{carrierBehavior:"transform"}),
    [I.NO_QUARTER]:row(I.NO_QUARTER,"instrument","#77a4ff",["audioInput","audioOutput","generator","noteInput","midiInput"],[]),
    [I.RANDRONE]:row(I.RANDRONE,"generator","#9efcff",["audioInput","audioOutput","generator","noteInput","midiInput","clockFollower"],["midi"]),
    ...
    [I.MIDICHLORIAN]:row(I.MIDICHLORIAN,"routing","#8bcf7a",["midi","midiInput"],["midi"]),
