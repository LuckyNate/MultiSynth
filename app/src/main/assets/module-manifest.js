...
(function(global){
  ...
  const M=Object.freeze({
    ...
    [I.PURE_SYNTH]:row(I.PURE_SYNTH,"PureSynth","rack-module-editor.html",I.PURE_SYNTH,"instrument","#f4f4f0",["audioInput","audioOutput","generator","noteInput","cvInput"],[]),
    [I.QUAD_SYNTH]:row(I.QUAD_SYNTH,"QuadSynth","rack-module-editor.html",I.QUAD_SYNTH,"instrument","#ffb000",["audioInput","audioOutput","generator","noteInput","cvInput"],[]),
    [I.PULSYNTH]:row(I.PULSYNTH,"Pulsynth","rack-module-editor.html",I.PULSYNTH,"instrument","#58ff78",["audioInput","audioOutput","generator","noteInput","cvInput"],[]),
    [I.SIN_LADDER]:row(I.SIN_LADDER,"SinLadder","rack-module-editor.html",I.SIN_LADDER,"instrument","#36eaff",["audioInput","audioOutput","generator","noteInput","cvInput"],[]),
    [I.RAZORBACK]:row(I.RAZORBACK,"Razorback","rack-module-editor.html",I.RAZORBACK,"instrument","#ff3d42",["audioInput","audioOutput","generator","noteInput","cvInput"],[]),
    [I.STINGER]:row(I.STINGER,"Stinger","rack-module-editor.html",I.STINGER,"instrument","#ffe64a",["audioInput","audioOutput","generator","noteInput","cvInput"],[]),
    [I.NO_QUARTER]:row(I.NO_QUARTER,"No Quarter","rack-module-editor.html",I.NO_QUARTER,"instrument","#77a4ff",["audioInput","audioOutput","generator","noteInput","cvInput"],[]),
    [I.RANDRONE]:row(I.RANDRONE,"Randrone","rack-module-editor.html",I.RANDRONE,"generator","#9efcff",["audioInput","audioOutput","generator","cvInput","clockFollower"],[]),
    [I.HOOKWORM]:row(I.HOOKWORM,"Hookworm","rack-module-editor.html",I.HOOKWORM,"looper","#e98232",["audioInput","audioOutput","mic","clockFollower"],["mic","storage"]),
    [I.TAPEWORM]:row(I.TAPEWORM,"Tapeworm","rack-module-editor.html",I.TAPEWORM,"looper","#f58ab3",["audioInput","audioOutput","mic","clockFollower"],["mic","storage"]),
