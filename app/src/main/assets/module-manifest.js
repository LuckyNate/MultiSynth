...
(function(global){
  ...
  const M=Object.freeze({
    ...
    [I.WHITMAN_SAMPLER]:row(I.WHITMAN_SAMPLER,"sampler","#6b3f24",["audioInput","audioOutput","noteInput","clockFollower","cvInput","cvOutput","pcm"],["pcm","storage"],{carrierBehavior:"add"}),
    [I.TIME_BANDITS]:row(I.TIME_BANDITS,"rhythm","#c89b52",["audioInput","audioOutput","clockFollower","cvInput","cvOutput"],[],{carrierBehavior:"add"}),
