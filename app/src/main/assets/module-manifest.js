...
(function(global){
  ...
  const M=Object.freeze({
    ...
    [I.REARRANGER]:row(I.REARRANGER,"sequencer","#b75cff",["audioInput","audioOutput","clockSource","clockFollower","cvInput","cvOutput"],[],{audioRole:"passthrough",carrierBehavior:"passthrough"}),
