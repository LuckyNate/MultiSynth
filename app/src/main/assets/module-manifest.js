...
(function(global){
  ...
  const M=Object.freeze({
    ...
    [I.WS]:row(I.WS,"sampler","#6b3f24",["audioInput","audioOutput","noteInput","clockFollower","dvInput","cvInput","pcm"],["pcm","storage"],{carrierBehavior:"add"}),
    ...
    [I.UNSTABLE_DIFFUSION]:row(I.UNSTABLE_DIFFUSION,"instrument","#e8e8e8",["audioOutput","generator","noteInput","pcm"],["pcm","storage"],{audioRole:"generator"}),
