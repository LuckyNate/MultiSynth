...
console.log("quadsynth: CLICK duration is generated by SHAPE independently of note Hz; note Hz only sets trigger spacing, so gaps, joins and overlap emerge naturally while every click reaches full amplitude");
